...
#define pci_obtain_card(__p0) \
	LP1(186, BOOL , pci_obtain_card, \
...
#define pci_physic_to_logic_addr(__p0, __p1) \
	LP2(180, APTR , pci_physic_to_logic_addr, \
		APTR , __p0, a0, \
		struct pci_dev *, __p1, a1, \
		, OPENPCI_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define pci_release_card(__p0) \
	LP1NR(192, pci_release_card, \
		struct pci_dev *, __p0, a0, \
		, OPENPCI_BASE_NAME, 0, 0, 0, 0, 0, 0)
